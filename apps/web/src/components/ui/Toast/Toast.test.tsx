...
describe(desc(TestScope.UI, "Toast", TestType.RENDU), () => {
...
describe(desc(TestScope.UI, "Toast", TestType.INTERACTIONS), () => {
...
describe(desc(TestScope.UI, "Toast", TestType.A11Y), () => {
  it("n'a pas de violations", async () => {
    const { container } = render(<ToastContainer toasts={mockToasts} onRemove={vi.fn()} />);
