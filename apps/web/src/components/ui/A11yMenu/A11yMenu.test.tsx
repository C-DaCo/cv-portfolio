...
describe(desc(TestScope.UI, "A11yMenu", TestType.RENDU), () => {
  beforeEach(() => {
    localStorage.clear();
  ...
  it("affiche les 4 switches quand ouvert", () => {
    render(<A11yMenu />);
...
describe(desc(TestScope.UI, "A11yMenu", TestType.INTERACTIONS), () => {
  beforeEach(() => {
    localStorage.clear();
    document.documentElement.className = "";
  });
...
describe(desc(TestScope.UI, "A11yMenu", TestType.A11Y), () => {
